...
Namespace BusinessValidation
    Public Class CheckBoxMustSelectedIssue
        Inherits IssueBase
        ...
        Public Shared Sub Assert(ByVal expression As Boolean, ByVal businessObject As IBusinessObject, ByVal errorMessage As String)
            If expression Then
                businessObject.ValidationIssues.Add(New CheckBoxMustSelectedIssue(businessObject,
                                                                            errorMessage))
            Else
        ...
        Public Shared Function GetKey(ByVal businessObject As IBusinessObject) As String
            Return String.Format("{0}:{1}:", businessObject.Guid, GetType(CheckBoxMustSelectedIssue).FullName)
        End Function
    End Class
End Namespace