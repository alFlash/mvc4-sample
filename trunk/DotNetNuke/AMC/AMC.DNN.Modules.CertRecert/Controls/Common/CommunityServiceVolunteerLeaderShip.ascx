<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CommunityServiceVolunteerLeaderShip.ascx.vb"
    Inherits="AMC.DNN.Modules.CertRecert.Controls.Common.CommunityServiceVolunteerLeaderShip" %>
<%@ Register TagPrefix="amc" TagName="DateTime" Src="../Reusable/AMCDatetime.ascx" %>
<script type="text/javascript">
    function showPracticePopup(isShow) {
        AmcCert.showPracticePopup("add-communityVolunteerLeaderShip", isShow);
        AmcCert.SetTitle("add-communityVolunteerLeaderShip", "Add Information ");
    }
    ...
    jQuery(document).ready(function () {
        var bindingList = [['lblNameOfOrganization', 'txtNameOfOrganization'],
                           ...
                           ['lblTermOfOfficeEndDate', 'txtEndDate'],
                           ['lblPoint', 'txtPoint']];
        var practicePopup = new AMCTablePopUp(bindingList,
            "communityVolunteerLeaderShip-uc",
            "tblCommunityVolunteerLeaderShip",
            "add-communityVolunteerLeaderShip",
            "Add Information ",
            "Edit Item",
            null);
    });
...
<div id="communityVolunteerLeaderShip-uc" class="amc-page">
    ...
    <div class="amc-title">
        <asp:Label runat="server" ID="lblCommunityServiceVolunteerLeaderShip"></asp:Label>
    </div>
    ...
    <div class="amc-contents">
        ...
        <div>
            <asp:Repeater runat="server" ID="rptCommunityVolunteerLeaderShip" EnableViewState="True">
                <HeaderTemplate>
                    <table id="tblCommunityVolunteerLeaderShip" border="1px" class="amc-table">
                        <tr class="amc-table-header">
                            ...
                            <td visible='<%# GetFieldInfo("TermOfOfficeStartDate").IsEnabled %>' runat="server">
                                <asp:Label runat="server" ID="lblTermOfOfficeStartDateHeader" Text='<%# GetFieldInfo("TermOfOfficeStartDate").FieldValue %>'></asp:Label>
                            </td>
                            <td visible='<%# GetFieldInfo("TermOfOfficeEndDate").IsEnabled %>' runat="server">
                                <asp:Label runat="server" ID="lblTermOfOfficeEndDateHeader" Text='<%# GetFieldInfo("TermOfOfficeEndDate").FieldValue %>'></asp:Label>
                            </td>
                ...
                <ItemTemplate>
                    <tr class="amc-table-content">
                        ...
                        <td visible='<%# GetFieldInfo("TermOfOfficeEndDate").IsEnabled %>' runat="server">
                            <asp:Label runat="server" ID="lblTermOfOfficeEndDate"></asp:Label>
                        </td>
    ...
    <div id="add-communityVolunteerLeaderShip" class="amc-popup">
            ...
            <div>
                ...
                <table class="width500">
                    ...
                    <tr id="TermOfOfficeStartDate" runat="server">
                     ...
                     <tr id="TermOfOfficeEndDate" runat="server">
                        <td>
                            <asp:Label runat="server" ID="lblTermOfOfficeEndDate"></asp:Label>
                        </td>
                        <td>
                            ...
                            <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ID="rqTermOfOfficeEndDate"
