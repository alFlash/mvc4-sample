...
Namespace Controls.Common
    ''' <summary>
    ''' Prepresent GUI for CommunityServicePresentation tab 
    ''' </summary>
    Public Class CommunityServicePresentation
...
#Region "Event Handlers"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
            Try
                AddEventHandlers()
                ProgramType = ActivityProgramType.COMMSERVPRES.ToString()
                ...
                If activityExternals IsNot Nothing Then
                    ...
                    Else
                        If ModuleConfigurationHelper.Instance.IsValidationRuleEnabled(
                                                             ValidationRuleId.COMMUNITY_SERVICE_PRESENTATION_OPTIONAL.ToString(),
                    ...
                    End If
                End If
                rptCommunityPresentation.DataSource = activityExternals
                rptCommunityPresentation.DataBind()
        ...
        Private Sub SetPropertiesForObject(ByRef objectItem As IUserDefinedCustomerCEActivity)
            If objectItem IsNot Nothing Then
                ...
                With objectItem
                    ...
                    .ProgramSponsor = txtNameOfSponsor.Text
