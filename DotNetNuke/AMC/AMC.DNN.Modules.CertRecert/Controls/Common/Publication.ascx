<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Publication.ascx.vb"
    Inherits="AMC.DNN.Modules.CertRecert.Controls.Common.Publication" %>
...
//                           ['lblpoint', 'hdnPointValuesDefault'],
                           ['lblpoint', 'txtPoint'],
            ...
            <asp:Repeater runat="server" ID="rptCommunityPublication" EnableViewState="True">
                ...
                <ItemTemplate>
                    <tr class="amc-table-content">
                        ...
                        <td idvisible='<%# GetFieldInfo("Point").IsEnabled %>' runat="server" class="text-right">
