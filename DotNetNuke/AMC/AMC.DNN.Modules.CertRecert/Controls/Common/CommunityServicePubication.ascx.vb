...
Namespace Controls.Common
    Public Class CommunityServicePubication
...
#Region "Event Handlers"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
            Try
                AddEventHandlers()
                ProgramType = ActivityProgramType.COMMSERVPUB.ToString()
            ...
            If activityExternals IsNot Nothing Then
                ...
                Else
                    If ModuleConfigurationHelper.Instance.IsValidationRuleEnabled(
                                                         ValidationRuleId.COMMUNITY_SERVICE_PUBLICATION_OPTIONAL.ToString(),
