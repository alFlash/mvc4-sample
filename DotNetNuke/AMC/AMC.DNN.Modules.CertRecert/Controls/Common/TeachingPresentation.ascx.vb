...
Namespace Controls.Common
    Public Class TeachingPresentation
...
#Region "Event Handlers"
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
            Try
                AddEventHandlers()
                ProgramType = ActivityProgramType.TEACHINGPRESN.ToString()
                ...
                If otherModuleSettings IsNot Nothing Then
                    maxCEHoursARN = If(otherModuleSettings.PresentationTotalHours.HasValue, otherModuleSettings.PresentationTotalHours.Value, 0)
                End If
        ...
        Public Overrides Function Save() As IIssuesCollection
            Try
                ...
                If ModuleConfigurationHelper.Instance.IsValidationRuleEnabled(ValidationRuleId.PRESENTATIONS_OPTIONAL.ToString(), Server.MapPath(ParentModulePath)) Then
                    hdIsIncomplete.Value = CommonConstants.TAB_COMPLETED
                Else
                    '' check validation
                    ...
                    If Not String.IsNullOrEmpty(ConflictMessage) Then '' validation rule is conflicted
                        ...
                        Return iissueResult
                    End If
                    If RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_EQUAL_ARN.ToString() Then  '' 
                        If CheckBusinessValidationCommitData_ARN_Equal(errorMessages, MaxCEHoursARN, totalCEHours) Then
                            ...
                            Return iissueResult
                        End If
                    ElseIf RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_GREATER_ARN.ToString() Then  ''
                        If CheckBusinessValidationCommitData_ARN_AllowGreater(errorMessages, MaxCEHoursARN, totalCEHours) Then
                            iissueResult.Add(New CheckBoxMustSelectedIssue(New BusinessObject(), errorMessages))
                            hdIsIncomplete.Value = CommonConstants.TAB_INCOMPLETED
                            Return iissueResult
                        End If
                    ElseIf RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_MIM_MAX_ABNN.ToString() Then
                    ...
                    If rptCommunityPresentation.Items Is Nothing OrElse rptCommunityPresentation.Items.Count <= 0 Then
                        '' if check rule and set ceMin = 0 => pass basic rule
                        If RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_MIM_MAX_ABNN.ToString() AndAlso totalCEMin = 0 Then
                            hdIsIncomplete.Value = CommonConstants.TAB_COMPLETED
                        Else
                            hdIsIncomplete.Value = CommonConstants.TAB_INCOMPLETED
                        End If
        ...
        Protected Sub rptCommunityPresentation_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.RepeaterCommandEventArgs) Handles rptCommunityPresentation.ItemCommand
            Try
        ...
        ''' </summary>
        Protected Sub rptCommunityPresentation_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.RepeaterItemEventArgs) Handles rptCommunityPresentation.ItemDataBound
            Try
                If e.Item.ItemType = ListItemType.AlternatingItem OrElse e.Item.ItemType = ListItemType.Item Then
                    ...
                    If userdine IsNot Nothing Then
                        ...
                        If lblCEType IsNot Nothing AndAlso hdnCETypeValue IsNot Nothing AndAlso lblCE IsNot Nothing Then
                            ...
                            FactorIndex = "1"
                            If RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_EQUAL_ARN.ToString() OrElse
                                        RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_GREATER_ARN.ToString() Then   '' base on control panel 
                            ...
                            ElseIf RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_MIM_MAX_ABNN.ToString() Then '' base on weight of ceType
...
#Region "Private Methods"
        ...
        Private Sub BindingDataToList()
            ...
            Try
                ...
                If ActivityExternals IsNot Nothing Then
                    ...
                    End If
                End If
                Me.rptCommunityPresentation.DataSource = ActivityExternals
                Me.rptCommunityPresentation.DataBind()
        ...
        ''' </summary>
        ''' <param name="customerExternalDocumentItem"> Item Object need to set values </param>
...
#Region "validation ARN"
        ...
        Public Function CheckConflictValidation(ByRef ruleID As String,
            ...
            Dim validationABNN_MinMaxItem = ModuleConfigurationHelper.Instance.IsValidationRuleEnabled(
                                                              ValidationRuleId.RECERT_TEACH_PRESENTATION_MIM_MAX_ABNN.ToString(),
                                                              Server.MapPath(ParentModulePath))
            ...
            ElseIf validationABNN_MinMaxItem = True Then
                ruleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_MIM_MAX_ABNN.ToString()
                Return False
            ElseIf validationARN_Greater = True Then
                ruleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_GREATER_ARN.ToString()
                Return False
            ElseIf validationARN_Equal = True Then
                ruleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_EQUAL_ARN.ToString()
                Return False
            End If
        ...
        Private Sub BuildTitle()
            ...
            If RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_GREATER_ARN.ToString() Then
                BuildTitle_ARN_GreaterMaxHours()
            ElseIf RuleID = ValidationRuleId.RECERT_TEACH_PRESENTATION_EQUAL_ARN.ToString() Then
        ...
        Public Sub BuildTitle_ABNN_MinMaxPointsCEType()
            ...
            If programTypeSetting IsNot Nothing Then
                ...
                If currentRecertOption IsNot Nothing AndAlso programTypeSettingSummary IsNot Nothing Then
                    ...
                    End If
            End If
            If Not ModuleConfigurationHelper.Instance.IsValidationRuleEnabled(ValidationRuleId.PRESENTATIONS_OPTIONAL.ToString(), Server.MapPath(ParentModulePath)) Then '' check optional rule => not build title
