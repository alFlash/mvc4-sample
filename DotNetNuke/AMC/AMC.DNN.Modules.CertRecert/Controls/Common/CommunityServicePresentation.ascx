<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CommunityServicePresentation.ascx.vb"
    Inherits="AMC.DNN.Modules.CertRecert.Controls.Common.CommunityServicePresentation" %>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        var bindingList = [['lblNameOfProgram', 'txtNameOfProgram'],
                            ['lblNameOfSponsor', 'txtNameOfSponsor'],
...
<div id="communityPresentation-uc" class="amc-page">
    ...
    <div class="amc-title">
        <asp:Label runat="server" ID="lblCommunityServicePresentation"></asp:Label>
    </div>
            ...
            <asp:Repeater runat="server" ID="rptCommunityPresentation" EnableViewState="True">
                <HeaderTemplate>
                    <table id="tblCommunityPresentation" border="1px" class="amc-table">
                        <tr class="amc-table-header">
                            ...
                            <td visible='<%# GetFieldInfo("NameOfSponsor").IsEnabled %>' runat="server">
                                <asp:Label runat="server" ID="lblNameOfSponsorHeader" Text='<%# GetFieldInfo("NameOfSponsor").FieldValue %>'></asp:Label>
                            </td>
                ...
                <ItemTemplate>
                    <tr class="amc-table-content" id="item-content">
                        ...
                        <td visible='<%# GetFieldInfo("NameOfSponsor").IsEnabled %>' runat="server">
                            <asp:Label runat="server" ID="lblNameOfSponsor" Text='<%# Eval("ProgramSponsor") %>'></asp:Label>
                        </td>
                        <td visible='<%# GetFieldInfo("TitlePresentation").IsEnabled %>' runat="server">
    ...
    <div id="add-communityPresentation" class="amc-popup">
        ...
        <asp:Panel runat="server" ID="panelPopup" DefaultButton="btnSave">
            ...
            <table class="width500">
                ...
                <tr id="NameOfSponsor" runat="server">
                    <td>
                        <asp:Label runat="server" ID="lblNameOfSponsor"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox runat="server" CssClass="width250" ID="txtNameOfSponsor"></asp:TextBox>
                        <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ID="rqNameOfSponsor"
                            ControlToValidate="txtNameOfSponsor" EnableClientScript="True" ValidationGroup="PopupRequiredGroup"
                            Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                </tr>
