    ...
    Public Class AffiliateManagement
        ...
        Public Shared Sub CreateAffiliateGroupActionInfo(ByVal PortalId As Integer, ByVal ActionType As enmGroupAction, ByVal arrGroupActionInfo As GroupActionAffiliateInfo())
            ...
            If (infoArray.Length > 0) Then
                ...
                SessionManager.AddSessionObject(PortalId, SessionManager.SessionKeys.PersonifyGroupActionInfo, objectToAdd, "")
            End If
            infoArray = Nothing
        End Sub

        Public Shared Function GetAffiliateGroupActionInfo(ByVal PortalId As Integer) As GroupActionAffiliateInfo()
            Dim info2 As GroupActionInfo = DirectCast(SessionManager.GetSessionObject(PortalId, SessionManager.SessionKeys.PersonifyGroupActionInfo, ""), GroupActionInfo)
        ...
        Public Shared Function GetCurrentAffiliateCustomerId(ByVal PortalId As Integer) As CustomerId
            ...
            Try 
                Dim info As AffiliateInfo = DirectCast(SessionManager.GetSessionObject(PortalId, SessionManager.SessionKeys.PersonifyCurrentAffiliateInfo, ""), AffiliateInfo)
        ...
        Public Shared Function GetCurrentAffiliateInfo(ByVal PortalId As Integer) As AffiliateInfo
            ...
            Try 
                Dim info2 As AffiliateInfo = DirectCast(SessionManager.GetSessionObject(PortalId, SessionManager.SessionKeys.PersonifyCurrentAffiliateInfo, ""), AffiliateInfo)
                info = info2
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
                Dim exception As Exception = exception1
        ...
        Public Shared Function GetCurrentSegmentGroupPurchaseActionURL(ByVal PortalId As Integer) As Integer
            ...
            Try 
                ...
                If AffiliateManagement.IsManagingSegment(PortalId) Then
                    currentSegmentInfo = AffiliateManagement.GetCurrentSegmentInfo(PortalId)
                Else
                    Return 0
                End If
        ...
        Public Shared Sub GetCurrentSegmentIdentifier(ByVal PortalId As Integer, ByRef SegmentType As String, ByRef SegmentQualifier1 As String, ByRef SegmentQualifier2 As String)
            Try 
                If AffiliateManagement.IsManagingSegment(PortalId) Then
                    Dim currentSegmentInfo As SegmentInfo = AffiliateManagement.GetCurrentSegmentInfo(PortalId)
        ...
        Public Shared Function GetCurrentSegmentInfo(ByVal PortalId As Integer) As SegmentInfo
            Return DirectCast(SessionManager.GetSessionObject(PortalId, SessionManager.SessionKeys.PersonifyCurrentSegmentInfo, ""), SegmentInfo)
        End Function

        Public Shared Function GetGroupPurchaseCartGUID(ByVal PortalId As Integer) As String
            Return AffiliateManagement.GetGroupPurchaseInfo(PortalId).CartGUID
        End Function

        Public Shared Function GetGroupPurchaseInfo(ByVal PortalId As Integer) As GroupActionInfo
            Dim info3 As GroupActionInfo
            Dim info2 As GroupActionInfo = DirectCast(SessionManager.GetSessionObject(PortalId, SessionManager.SessionKeys.PersonifyGroupPurchaseInfo, ""), GroupActionInfo)
        ...
        Public Shared Function GetMemberInfoForCurrentSegment(ByVal PortalId As Integer) As CustomerId
            ...
            Try 
                ...
                If AffiliateManagement.IsManagingSegment(PortalId) Then
                    Return AffiliateManagement.GetCurrentSegmentInfo(PortalId).SegmentMember
                End If
                id = id2
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
        ...
        Public Shared Sub ManageAffiliate(ByVal PortalId As Integer, ByVal AffiliateMasterCustomerId As String, ByVal AffiliateSubCustomerId As Integer, ByVal AffiliateLabelName As String, ByVal EditProfileFlag As Boolean)
            Try 
                If AffiliateManagement.IsManagingSegment(PortalId) Then
                    ...
                    SessionManager.AddSessionObject(PortalId, SessionManager.SessionKeys.PersonifyCurrentAffiliateInfo, objectToAdd, "")
                End If
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
                Dim exception As Exception = exception1
        ...
        Public Shared Sub RemoveAffiliateGroupActionInfo(ByVal PortalId As Integer)
            SessionManager.ClearSessionObject(PortalId, SessionManager.SessionKeys.PersonifyGroupActionInfo, "")
        End Sub

        Private Shared Sub RemoveCurrentAffiliate(ByVal PortalId As Integer)
            SessionManager.ClearSessionObject(PortalId, SessionManager.SessionKeys.PersonifyCurrentAffiliateInfo, "")
        End Sub

        Public Shared Sub RemoveCurrentSegmentInfo(ByVal PortalId As Integer)
            SessionManager.ClearSessionObject(PortalId, SessionManager.SessionKeys.PersonifyCurrentSegmentInfo, "")
        End Sub

        Public Shared Sub RemoveGroupPurchaseInfo(ByVal PortalId As Integer)
            SessionManager.ClearSessionObject(PortalId, SessionManager.SessionKeys.PersonifyGroupPurchaseInfo, "")
        End Sub
        ...
        Public Shared Sub SetCurrentSegmentGroupPurchaseActionURL(ByVal PortalId As Integer, ByVal GroupPurchaseActionURL As Integer)
            Try 
                If AffiliateManagement.IsManagingSegment(PortalId) Then
                    ...
                    SessionManager.AddSessionObject(PortalId, SessionManager.SessionKeys.PersonifyCurrentSegmentInfo, currentSegmentInfo, "")
                End If
            Catch exception1 As Exception
                ProjectData.SetProjectError(exception1)
                Dim exception As Exception = exception1
        ...
        Public Shared Sub SetGroupPurchaseInfo(ByVal PortalId As Integer, ByVal CartGUID As String)
            ...
            SessionManager.AddSessionObject(PortalId, SessionManager.SessionKeys.PersonifyGroupPurchaseInfo, objectToAdd, "")
        End Sub
        ...
        Public Shared Sub StopManagingAffiliate(ByVal PortalId As Integer)
            AffiliateManagement.RemoveCurrentAffiliate(PortalId)
        End Sub
